...
public class Veza extends Turtle implements Figurka {
	...
	public Veza(int tim, int poziciaX, int poziciaY) {
		...
		nacitajTahy();
		if (tim == 2) {
			setShape(new ImageTurtleShape("/veza_biely.png"));
		} else {
			setShape(new ImageTurtleShape("/veza_cierny.png"));
		}
