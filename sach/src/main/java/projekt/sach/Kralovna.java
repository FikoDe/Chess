...
public class Kralovna extends Turtle implements Figurka {
	...
	public Kralovna(int tim, int poziciaX, int poziciaY) {
		...
		nacitajTahy();
		if (tim == 2) {
			setShape(new ImageTurtleShape("/kralovna_biely.png"));
		} else {
			setShape(new ImageTurtleShape("/kralovna_cierny.png"));
		}
